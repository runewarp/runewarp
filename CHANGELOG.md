...
- Added the Managed-session protocol and Control interoperability guide in `docs/managed.md`, with cross-links from architecture, protocol, security, configuration, usage, and the README documentation index. (#159)
