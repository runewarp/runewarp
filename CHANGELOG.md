...
- Prefactored static Server authorization behind one atomically replaceable **Authorization snapshot** shared by Public-hostname routing and QUIC Client-identity handshake admission, including targeted connection-close and stream-reset dispatch seams. (#160)
