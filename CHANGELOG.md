...
- Bounded Managed-session SSE framing, snapshot size, decoded allocation, and role-input cardinalities; moved applied-state reporting off the reconciliation critical path with coalesced latest-revision acknowledgments, bodyless-204 enforcement, and 5-second request/response deadlines. (#200)
