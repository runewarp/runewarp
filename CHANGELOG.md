...
- Added required managed Server **Tunnel ID** (`tunnels[].id`): opaque Control-owned continuity keys (shared validation with revision), ID-keyed live pool rematch on apply, and static mode remains ID-less. (#TBD)
