...
- managed Client mode emits per-address Establishing, Connected, Reconnecting, Closed, and failed-attempt events plus aggregate convergence transitions, and does not emit the static one-shot Client-ready event
