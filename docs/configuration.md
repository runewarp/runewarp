...
| `server.visitor-proxy-trusted-networks` | with Visitor PROXY v2 | Non-empty IPv4/IPv6 CIDRs whose accepted socket peers may supply Visitor metadata. Hosts require `/32` or `/128`. |
