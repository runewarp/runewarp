...
Core's shared **Managed session** contract is documented in [`docs/managed.md`](managed.md). The items below remain exploratory managed-service work beyond that Core wire contract.
